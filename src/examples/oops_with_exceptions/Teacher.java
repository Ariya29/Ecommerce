...
public class Teacher extends User {
	...
	public void checkPaper(Exam e) throws PaperNotReadyForCheckingException {
		
		if (this.isLoginStatus()) {
			
			if (e.getQuestions()[0] == null || e.getAnswers()[0] == null)
				throw new PaperNotReadyForCheckingException();
